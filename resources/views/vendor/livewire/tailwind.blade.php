<div>
    @if ($paginator->total())
        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            {{-- small screen previous/next buttons --}}
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                ...
                <div>
                    <span class="relative z-0 inline-flex -space-x-px">
                        <span>
                            {{-- Previous Page Link --}}
                            @if ($paginator->onFirstPage())
                            ...
                            @else
                                ...
                                >
                                    <svg class="w-5 h-5 transition duration-300 ease-in-out transform hover:scale-125" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
                                    </svg>
                                </button>
                            @endif
                        ...
                        {{-- @foreach ($elements as $element) --}}
                            ...
                            {{-- @if (is_string($element))
                                <span aria-disabled="true">
                                    <span class="bg-white border-gray-300 text-gray-500 hover:bg-gray-50 relative inline-flex items-center px-4 py-2 border text-sm font-medium">{{ $element }}</span>
                                </span>
                            @endif --}}
                        ...
                        <span>
                            ...
                            @if ($paginator->hasMorePages())
                                <button
                                    ...
                                    rel="next"
                                    class="relative inline-flex items-center pl-2 py-2 text-sm font-medium text-gray-500"
